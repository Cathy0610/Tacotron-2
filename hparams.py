...
hparams = tf.contrib.training.HParams(
	...
	tacotron_input_channel = 1, # 1: zh/en/cmu/py; 2: py2
	...
	tacotron_reference_stride_size = ((2, 1), (2, 1), (2, 2), (2, 2), (2, 2), (2, 2)), # stride of style token layer
	...
	tacotron_emo_loss_weight_init = 0.01,
	tacotron_emo_loss_weight_final = 1.0,
	tacotron_emo_loss_weight_start_grow = 20000,
	tacotron_emo_loss_weight_grow_steps = 15000,
	tacotron_emo_loss_weight_rate = 0.5,
	...
	tacotron_synthesis_batch_size = 32*1, #DO NOT MAKE THIS BIGGER THAN 1 IF YOU DIDN'T TRAIN TACOTRON WITH "mask_encoder=True"!!
	...
	tacotron_start_decay = 210000, #Step at which learning decay starts
	tacotron_decay_steps = 40000, #Determines the learning rate decay slope (UNDER TEST)
	tacotron_decay_rate = 0.5, #learning rate decay rate (UNDER TEST)
	tacotron_initial_learning_rate = 5e-4, #starting learning rate
